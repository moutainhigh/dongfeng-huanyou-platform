 ...
 */
@Component
public class Gps_3064_TRCollectStatusSignalRes extends Command {
...
//			
//			TRCollectStatusSignalRes res=TRCollectStatusSignalRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集记录仪状态信号配置信息应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3064");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集记录仪状态信号配置信息应答异常", e);
		}
		return null;
	}
