...
/**
 * 采集事故疑点应答
 * Gps_3057_TRDoubtCollectionRes
 * @author maojin
 *
 */
@Component
public class Gps_3057_TRDoubtCollectionRes extends Command{
...
//			
//			TRDoubtCollectionRes res=TRDoubtCollectionRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "行驶记录仪--采集事故疑点应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3057");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("行驶记录仪--采集事故疑点应答", e);
		}
		return null;
	}
