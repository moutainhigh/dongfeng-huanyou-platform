 ...
 */
@Component
public class Gps_3063_TRCollectVehicleInfoRes extends Command {
...
//			
//			TRCollectVehicleInfoRes res=TRCollectVehicleInfoRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集车辆信息应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3063");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集车辆信息应答异常", e);
		}
		return null;
	}
