 ...
 */
@Component
public class Gps_3060_TRCollectDriverInfoRes extends Command {
...
//			
//			TRCollectDriverInfoRes res=TRCollectDriverInfoRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集当前驾驶员信息应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3060");
//			GpsCommandFactory.processor(packet);
//			}

		} catch (Exception e) {
			log.error("采集当前驾驶员信息应答", e);
		}
		return null;
	}
