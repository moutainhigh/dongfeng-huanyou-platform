 ...
 */
@Component
public class Gps_3066_TRCollectLocationDataRes extends Command {
...
//			
//			TRCollectLocationDataRes res=TRCollectLocationDataRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集指定的位置信息记录应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3066");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集指定的位置信息记录应答异常", e);
		}
		return null;
	}
