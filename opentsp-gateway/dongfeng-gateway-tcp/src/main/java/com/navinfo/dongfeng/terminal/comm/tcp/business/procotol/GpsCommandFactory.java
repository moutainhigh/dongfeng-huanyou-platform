...
public class GpsCommandFactory {
	public static Logger logger = LoggerFactory.getLogger(GpsCommandFactory.class);

	public static Object processor(Packet packet) {
		String cmd = Command.PrefixGps+ packet.getCommand().toUpperCase();
