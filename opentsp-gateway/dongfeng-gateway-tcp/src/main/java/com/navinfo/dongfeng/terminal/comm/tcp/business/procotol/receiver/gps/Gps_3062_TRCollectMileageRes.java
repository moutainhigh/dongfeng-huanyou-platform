 ...
 */
@Component
public class Gps_3062_TRCollectMileageRes extends Command {
...
//			
//			TRCollectMileageRes res=TRCollectMileageRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集累计行驶里程应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3062");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集累计行驶里程应答异常", e);
		}
		return null;
	}
