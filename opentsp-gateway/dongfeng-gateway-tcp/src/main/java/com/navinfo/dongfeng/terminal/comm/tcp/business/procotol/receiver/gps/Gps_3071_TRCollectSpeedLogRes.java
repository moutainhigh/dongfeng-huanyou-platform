 ...
 */
@Component
public class Gps_3071_TRCollectSpeedLogRes extends Command {
...
//			
//			TRCollectSpeedLogRes res=TRCollectSpeedLogRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集指定的速度状态日志应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3071");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集指定的速度状态日志应答异常", e);
		}
		return null;
	}
