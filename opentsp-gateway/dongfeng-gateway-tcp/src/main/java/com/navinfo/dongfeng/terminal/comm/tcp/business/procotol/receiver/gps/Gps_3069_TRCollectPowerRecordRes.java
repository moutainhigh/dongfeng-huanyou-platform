 ...
 */
@Component
public class Gps_3069_TRCollectPowerRecordRes extends Command {
...
//			
//			TRCollectPowerRecordRes res=TRCollectPowerRecordRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集指定的外部供电记录应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3069");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集指定的外部供电记录应答异常", e);
		}
		return null;
	}
