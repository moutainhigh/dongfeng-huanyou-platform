...
/**
 * 采集速度应答 Gps_3056_TRSpeedCollectionRes
 * 
 * @author maojin
 * 
 */
@Component
public class Gps_3056_TRSpeedCollectionRes extends Command {
...
//			
//			TRSpeedCollectionRes res=TRSpeedCollectionRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "行驶记录仪--采集速度应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3056");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("行驶记录仪--采集速度应答", e);
		}
		return null;
	}
