...
/**
 * 位置查询应答 Gps_3050_LocationDataQueryReps
 * 
 * @author dell CallNameRes
 */
@Component
public class Gps_3050_LocationDataQueryReps extends Command {
...
//			packet.setContentForBytes(sendContent);
			...
			sendMsgToClient(packet, "位置查询应答");
		} catch (Exception e) {
			log.error("位置查询应答异常", e);
		}
		return null;
	}
