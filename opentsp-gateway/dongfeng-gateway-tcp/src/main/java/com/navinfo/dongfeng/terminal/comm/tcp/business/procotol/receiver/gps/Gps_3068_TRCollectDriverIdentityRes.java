 ...
 */
@Component
public class Gps_3068_TRCollectDriverIdentityRes extends Command {
...
//			
//			TRCollectDriverIdentityRes res=TRCollectDriverIdentityRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集指定的驾驶人身份记录应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3068");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集指定的驾驶人身份记录应答异常", e);
		}
		return null;
	}
