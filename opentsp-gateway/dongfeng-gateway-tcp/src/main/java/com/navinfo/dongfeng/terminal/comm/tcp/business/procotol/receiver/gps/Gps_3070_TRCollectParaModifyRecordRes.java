 ...
 */
@Component
public class Gps_3070_TRCollectParaModifyRecordRes extends Command {
...
//			
//			TRCollectParaModifyRecordRes res=TRCollectParaModifyRecordRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集指定的参数修改记录应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3070");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集指定的参数修改记录应答异常", e);
		}
		return null;
	}
