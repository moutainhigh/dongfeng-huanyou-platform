package com.navinfo.dongfeng.terminal.comm.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.navinfo.dongfeng.terminal.comm.cmd.base.BaseCmd;
import com.navinfo.dongfeng.terminal.comm.common.exception.CommandHandlingException;
import com.navinfo.dongfeng.terminal.comm.common.handler.CommandHandler;
...
public class WebController
{
    ...
    private ArrayList valueGetKey(Map map, String value)
    {
        ...
        ArrayList arr = new ArrayList<String>();// 新建一个集合
