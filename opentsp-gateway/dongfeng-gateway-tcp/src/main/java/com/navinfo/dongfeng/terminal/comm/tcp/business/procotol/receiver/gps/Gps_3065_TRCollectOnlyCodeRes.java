 ...
 */
@Component
public class Gps_3065_TRCollectOnlyCodeRes extends Command {
...
//			
//			TRCollectOnlyCodeRes res=TRCollectOnlyCodeRes.parseFrom(packet.getContentForBytes());
...
//			if(null==oldPacket){
			...
			sendMsgToClient(packet, "采集记录仪唯一性编号应答");
//			}else{//809发送的
//				packet.setCommand("5115");
//				packet.addParameter("oldCommand", "3065");
//			GpsCommandFactory.processor(packet);
//			}
		} catch (Exception e) {
			log.error("采集记录仪唯一性编号应答异常", e);
		}
		return null;
	}
