 ...
 * @copyright Navi Tsp
 */
public class AddBusinessCommand extends BaseCommand<HttpCommandResultWithData> {
    ...
    public String toString() {
        return "AddBusinessCommand{" +
                "  businessCode='" + businessCode + '\'' +
                ", businessName='" + businessName + '\'' +
                ", addressCode='" + addressCode + '\'' +
                ", linkPerson='" + linkPerson + '\'' +
                ", linkTelpone='" + linkTelpone + '\'' +
                ", fax='" + fax + '\'' +
                ", addressCommon='" + addressCommon + '\'' +
                ", common='" + common + '\'' +
                ", cType='" + ctype + '\'' +
                ", certificateCode='" + certificateCode + '\'' +
                ", vehicleLicCode='" + vehicleLicCode + '\'' +
                ", roadTransLicCode='" + roadTransLicCode + '\'' +
