...
public class NotOnlineReportPojo {
	...
	private LCLocationData.LocationData gpsdata;
	...
	public LCLocationData.LocationData getGpsdata() {
		return gpsdata;
	}

	public void setGpsdata(LCLocationData.LocationData gpsdata) {
