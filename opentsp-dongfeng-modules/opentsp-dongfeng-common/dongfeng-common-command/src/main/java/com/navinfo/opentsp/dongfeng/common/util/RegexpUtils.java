...
public final class RegexpUtils {
     ...
     * 11位手机号格式验证
     */
    public static final String MOBILE_PHONE_REGEXP = "^1[3,4,5,7,8]\\d{9}$";
     ...
     * 匹配11位数字
     */
    public static final String ELEVEN_NUMBER_ONLY_REGEXP = "^[0-9]{11}$";
     ...
     * 匹配车终端设备ID
     */
    public static final String TERMINAL_LABEL_ID = "^[0-9a-zA-Z]{36}$";
    ...
    /**
     * 匹配日期 格式: yyyy-mm 匹配 : 2005-04 不匹配: 01-01-01
     */
    public static final String DATE_YYYY_MM_REGEXP = "^(\\d{4})-(0\\d{1}|1[0-2])$";
    ...
    public static final String NUMBER_COMMA_REGEXP = "^[\\d,]+$";

    /**
     * 密码校验
     * 规则：必须同时包含大写字母\小写字母\数字、特殊字符可有可无，长度为8到16
     */
    public static final String PASSWORD_REGEXP = "^(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])(?![\\W_]*$)\\S{8,16}$";
    ...
    public static void main(String[] args) {
         ...
         * 日期格式正确
         */
        // String date1 = "2014.03.01";

        // System.out.println(test("2125070219645"));
        // System.out.println(test(" "));

        // String sn1 = "311601001238";
        // System.out.println(test(sn1));
        // String sn2 = "836602006123c";
        // &token=tp1TudtvXJJnPae%2Fr5clPp3b9aw%3D&__rid=0.7466145248451266
        // System.out.println(test("200"));
        // System.out.println(test("11"));
//        System.out.println(validateInfo("1,2", NUMBER_COMMA_REGEXP));
//        System.out.println(validateInfo("11,2", NUMBER_COMMA_REGEXP));
//        System.out.println(validateInfo("1,22", NUMBER_COMMA_REGEXP));
//        System.out.println(validateInfo("-111,2", NUMBER_COMMA_REGEXP));
//        System.out.println(validateInfo("a,2", NUMBER_COMMA_REGEXP));
        System.out.println(validateInfo("0018-04", DATE_YYYY_MM_REGEXP));
    ...
    public static boolean test(String date) {
        ...
        Pattern pat = Pattern.compile(DATE_SLASH_REGEXP);
