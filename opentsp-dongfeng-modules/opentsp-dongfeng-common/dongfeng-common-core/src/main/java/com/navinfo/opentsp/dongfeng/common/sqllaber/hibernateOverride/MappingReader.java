...
public class MappingReader
{
     ...
     * <p/>
     * Eventually we perhaps need to have this configurable by the "configuration" and simply reference it from there
     * (registry). This would allow, for example, injection of the entity resolver to use as instance state.
     */
    ...
    private XMLEventReader buildStaxEventReader(InputSource source, Origin origin)
    {
        ...
        if (source.getByteStream() != null)
        {
            ...
            {
                throw new XmlInfrastructureException("Unable to create stax reader, origin = "
                    + toLoggableString(origin), e);
            }
        }
    ...
    {
        ORM_1_0("org/hibernate/jpa/orm_1_0.xsd"), ORM_2_0("org/hibernate/jpa/orm_2_0.xsd"), ORM_2_1(
