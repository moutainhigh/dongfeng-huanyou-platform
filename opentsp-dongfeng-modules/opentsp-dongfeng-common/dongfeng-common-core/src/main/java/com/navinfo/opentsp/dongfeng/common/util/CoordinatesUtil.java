...
public class CoordinatesUtil {
    ...
    public static String[] gcj2WGSExactly(String gcjLat, String gcjLon) {
        double[] temp = gcj2WGSExactly(Double.valueOf(gcjLat), Double.valueOf(gcjLon));
        String[] re = new String[temp.length];
        re[0] = String.valueOf(temp[0]);
        re[1] = String.valueOf(temp[1]);
        return re;
    }
