...
public class StringUtil
{
    ...
    public static String getBase64Str(String oldStr)
    {
        ...
        return new String(java.util.Base64.getEncoder().encode(oldStr.getBytes()));
    }
     ...
     * @return 返回截取后的字符
     */
    public static String removeFirstStr(String str)
    {
        if (isNotEmpty(str))
        {
            str = str.substring(1);
    ...
    {
        return StringUtils.collectionToDelimitedString(list, spliter);
    }
    ...
    {
        return (long)Math.round(Math.random() * 89999999999L + 10000000000L);
