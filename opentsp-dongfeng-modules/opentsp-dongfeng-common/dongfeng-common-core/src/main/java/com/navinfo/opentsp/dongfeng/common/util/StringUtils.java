...
public class StringUtils
{
    ...
    {
        int j;
        for (int b = 0; (j = str.indexOf(from, b)) != -1; b = j + to.length())
            str = str.substring(0, j) + to + str.substring(j + from.length());
        return str;
    }
     ...
     * 字符串数组拼接
     * 
     * @param names String[] 需要进行拼接的字符串数组
     * @param seperator String 拼接的分隔符
     * 
     * @return String 拼接后的字符串
     */
    public static String append(String[] names, String seperator)
    {
        StringBuffer buffer = new StringBuffer();
        append(buffer, names, seperator);
     ...
     * 字符串数组拼接
     * 
     * @param buffer StringBuffer 主字符串
     * @param names String[] 需要进行拼接的字符串数组
     * @param seperator String 拼接的分隔符
     */
    public static void append(StringBuffer buffer, String[] names, String seperator)
    {
        ...
        {
            buffer.append(seperator).append(names[i]);
        }
    }
     ...
     * 字符串分隔
     * 
     * @param string String 需要进行分隔的字符串
     * @param token String 分隔符
     * @param trim boolean 对分隔后的字符串是否需要进行去空格操作
     * 
     * @return String[]
     */
    public static String[] split(String string, String token, boolean trim)
    {
        if (!isEmpty(string))
        {
    ...
    /**
     * 将String类型转换为BigInteger类型,当转换失败时返回默认值
     *
     * @param str 待转换的字符串
     * @param def 默认值
     * @return
     */
    public static BigInteger toBigInteger(String str, BigInteger def)
    {
        BigInteger result = def;
        try
        {
            result = BigInteger.valueOf(Long.valueOf(str));
        }
        catch (Exception e)
        {
            return result;
     ...
     * @return
     */
    public static String nvlDef(final Object o, final String defaultValue)
    {
        return (null == o) ? defaultValue : o.toString().trim();
    }
     ...
     * @return
     */
    public static String nvlDef(final Object o)
    {
        return nvlDef(o, "0");
    }
     ...
     * @return 目标字符串
     */
    public static String collectionToDelimitedString(List list, String spliter)
    {
        return org.springframework.util.StringUtils.collectionToDelimitedString(list, spliter);
    }
     ...
     * @return
     */
    public static long generalAutoCommunication()
    {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(removeLastStr("123,123,", ","));
    }
