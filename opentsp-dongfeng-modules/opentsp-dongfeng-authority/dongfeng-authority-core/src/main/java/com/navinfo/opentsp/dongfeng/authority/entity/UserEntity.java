package com.navinfo.opentsp.dongfeng.authority.entity;
...
public class UserEntity implements Serializable
{
    ...
    @Column(nullable = true, name = "TER_AUTHORITY")
    private Integer terAuthority;
    ...
    public Integer getTerAuthority() {
        return terAuthority;
    }

    public void setTerAuthority(Integer terAuthority) {
