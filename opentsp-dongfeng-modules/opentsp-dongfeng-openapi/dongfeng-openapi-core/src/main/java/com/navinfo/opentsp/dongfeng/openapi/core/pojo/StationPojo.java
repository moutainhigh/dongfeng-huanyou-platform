...
public class StationPojo {
    ...
    private BigInteger stationLon;    //经度
    private BigInteger stationLat;    //纬度
    ...
    public BigInteger getStationLon() {
        return stationLon;
    }

    public void setStationLon(BigInteger stationLon) {
        this.stationLon = stationLon;
    }

    public BigInteger getStationLat() {
        return stationLat;
    }

    public void setStationLat(BigInteger stationLat) {
