 ...
 *
 * @wenya
 * @create 2017-03-13 20:52
 **/
public class QueryCarInfoDto {
    ...
    private String gpstimeVaild; //有效时间
    private Double lngValid; //有效经度
    private Double latValid;//有效纬度
    ...
    public String getFkCommNum() {
        return fkCommNum;
    }

    public void setFkCommNum(String fkCommNum) {
    ...
    public String getStdSalesTime() {
        return stdSalesTime;
    }

    public void setStdSalesTime(String stdSalesTime) {
        this.stdSalesTime = stdSalesTime;
    }

    public String getAakSalesTime() {
        return aakSalesTime;
    }

    public void setAakSalesTime(String aakSalesTime) {
        this.aakSalesTime = aakSalesTime;
    }
