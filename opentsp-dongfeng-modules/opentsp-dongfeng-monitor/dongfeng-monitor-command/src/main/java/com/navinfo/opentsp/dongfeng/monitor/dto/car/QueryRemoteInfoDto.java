...
public class QueryRemoteInfoDto {
	...
	private String engineTorMode;// Engine Torque Mode发动机扭矩模式 0 低怠速调节器/无请求（默认模式）1 加速踏板2 巡航控制3 PTO调节器4 车速调节器5
									// ASR控制6 变速器控制7 ABS控制 8 转矩限定9 高速调节器10 制动系统11 遥控加速器
